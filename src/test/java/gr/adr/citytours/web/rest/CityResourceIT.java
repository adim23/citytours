...
class CityResourceIT {
    ...
    public static City createEntity(EntityManager em) {
        City city = new City().code(DEFAULT_CODE).name(DEFAULT_NAME);
        return city;
    }
    ...
    public static City createUpdatedEntity(EntityManager em) {
        City city = new City().code(UPDATED_CODE).name(UPDATED_NAME);
        return city;
    }
    ...
    void putExistingCity() throws Exception {
        ...
        updatedCity.code(UPDATED_CODE).name(UPDATED_NAME);
    ...
    void partialUpdateCityWithPatch() throws Exception {
        ...
        partialUpdatedCity.code(UPDATED_CODE).name(UPDATED_NAME);
