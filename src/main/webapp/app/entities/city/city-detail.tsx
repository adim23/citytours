    ...
    <Row>
      <Col md="8">
        <h2 data-cy="cityDetailsHeading">
          <Translate contentKey="citytoursApp.city.detail.title">City</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="code">
              <Translate contentKey="citytoursApp.city.code">Code</Translate>
            </span>
          </dt>
          <dd>{cityEntity.code}</dd>
          <dt>
            <span id="name">
              <Translate contentKey="citytoursApp.city.name">Name</Translate>
            </span>
          </dt>
