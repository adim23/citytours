  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="citytoursApp.city.home.createOrEditLabel" data-cy="CityCreateUpdateHeading">
            <Translate contentKey="citytoursApp.city.home.createOrEditLabel">Create or edit a City</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('citytoursApp.city.code')} id="city-code" name="code" data-cy="code" type="text" />
              <ValidatedField
                label={translate('citytoursApp.city.name')}
                id="city-name"
                name="name"
                data-cy="name"
                type="text"
