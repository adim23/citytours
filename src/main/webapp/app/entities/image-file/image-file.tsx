  ...
  return (
    <div>
      <h2 id="image-file-heading" data-cy="ImageFileHeading">
        <Translate contentKey="citytoursApp.imageFile.home.title">Image Files</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="citytoursApp.imageFile.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/image-file/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="citytoursApp.imageFile.home.createLabel">Create new Image File</Translate>
          </Link>
        </div>
      </h2>
        ...
        {imageFileList && imageFileList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="citytoursApp.imageFile.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th>
                  <Translate contentKey="citytoursApp.imageFile.place">Place</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {imageFileList.map((imageFile, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{imageFile.place ? <Link to={`/place/${imageFile.place.id}`}>{imageFile.place.name}</Link> : ''}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="citytoursApp.imageFile.home.notFound">No Image Files found</Translate>
            </div>
          )
        )}
      </div>
