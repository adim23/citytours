...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_IMAGEFILE_LIST actions', async () => {
    ...
    it('dispatches FETCH_IMAGEFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_IMAGEFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_IMAGEFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_IMAGEFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_IMAGEFILE actions', async () => {
      const expectedActions = [
        {
