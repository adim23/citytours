  ...
  return (
    <div>
      <h2 id="driver-heading" data-cy="DriverHeading">
        <Translate contentKey="citytoursApp.driver.home.title">Drivers</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="citytoursApp.driver.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/driver/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="citytoursApp.driver.home.createLabel">Create new Driver</Translate>
          </Link>
        </div>
      </h2>
        ...
        {driverList && driverList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('age')}>
                  <Translate contentKey="citytoursApp.driver.age">Age</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('age')} />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="citytoursApp.driver.home.notFound">No Drivers found</Translate>
            </div>
          )
        )}
      </div>
