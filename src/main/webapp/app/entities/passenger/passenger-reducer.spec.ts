...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './passenger.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PASSENGER_LIST actions', async () => {
    ...
    it('dispatches FETCH_PASSENGER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PASSENGER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PASSENGER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PASSENGER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PASSENGER actions', async () => {
      const expectedActions = [
        {
