  ...
  return (
    <div>
      <h2 id="passenger-heading" data-cy="PassengerHeading">
        <Translate contentKey="citytoursApp.passenger.home.title">Passengers</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="citytoursApp.passenger.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/passenger/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="citytoursApp.passenger.home.createLabel">Create new Passenger</Translate>
          </Link>
        </div>
      </h2>
        ...
        {passengerList && passengerList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="citytoursApp.passenger.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="citytoursApp.passenger.home.notFound">No Passengers found</Translate>
            </div>
          )
        )}
      </div>
