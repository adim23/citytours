...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tour.reducer';
...
describe('Entities reducer tests', () => {
  ...
  const initialState: EntityState<ITour> = {
    loading: false,
    errorMessage: null,
    entities: [],
    entity: defaultValue,
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOUR_LIST actions', async () => {
    ...
    it('dispatches FETCH_TOUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOUR actions', async () => {
      const expectedActions = [
        {
