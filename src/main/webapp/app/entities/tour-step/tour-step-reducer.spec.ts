...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tour-step.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOURSTEP_LIST actions', async () => {
    ...
    it('dispatches FETCH_TOURSTEP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOURSTEP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOURSTEP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOURSTEP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOURSTEP actions', async () => {
      const expectedActions = [
        {
