...
import { ITourSchedule, defaultValue } from 'app/shared/model/tour-schedule.model';
import reducer, {
  createEntity,
  deleteEntity,
  getEntities,
...
describe('Entities reducer tests', () => {
  ...
  const initialState: EntityState<ITourSchedule> = {
    loading: false,
    errorMessage: null,
    entities: [],
    entity: defaultValue,
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOURSCHEDULE_LIST actions', async () => {
    ...
    it('dispatches FETCH_TOURSCHEDULE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOURSCHEDULE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOURSCHEDULE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOURSCHEDULE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOURSCHEDULE actions', async () => {
      const expectedActions = [
        {
