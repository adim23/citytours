...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, gr.adr.citytours.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, gr.adr.citytours.repository.UserRepository.USERS_BY_EMAIL_CACHE);
