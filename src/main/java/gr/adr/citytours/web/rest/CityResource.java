...
/**
 * REST controller for managing {@link gr.adr.citytours.domain.City}.
 */
@RestController
...
public class CityResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<City>> getAllCities(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
